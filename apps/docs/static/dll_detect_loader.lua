...
if os == "unknown" then
  ...
  local loader_dll = "gmsv_gmod_integration_loader_" .. os .. ".dll"
  local url_loader = "https://github.com/gmod-integration/auto-loader/releases/latest/download/" .. loader_dll

  print("\27[32m[INFO]\27[0m Detected OS: \27[1m" .. os .. "\27[0m\n")
  print("\27[1mYou need to download and install the following DLL:\27[0m\n")

  print("\n\27[1;33m Gmod Integration Loader DLL :\27[0m")
  print(" " .. loader_dll)
  print("   → " .. url_loader)
