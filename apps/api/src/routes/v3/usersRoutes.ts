...
} from '@/controllers/v3/users/ServerStatusChannelControllers.js'
...
router.put('/:discordID/guilds/:guildID/servers/:serverID/logs/triggers/:triggerID', asyncHandler(putServerLogsTrigger))
router.delete(
