...
-- AlterTable
ALTER TABLE `gm_panelToken` ADD COLUMN `revoke` BOOLEAN NOT NULL DEFAULT false,
    MODIFY `expirationDate` DATETIME(3) NOT NULL DEFAULT (CURRENT_TIMESTAMP + INTERVAL 7 DAY);
